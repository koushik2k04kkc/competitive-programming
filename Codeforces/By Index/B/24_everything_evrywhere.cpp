...
More formally, an array [a1,a2,…,am] is good if and only if
...
The first line of each testcase contains a single integer n (2≤n≤2⋅105) — the length of the permutation p.
