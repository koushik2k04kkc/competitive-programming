...
/*
Vlad found a strip of n
 cells, numbered from left to right from 1
 to n
. In the i
-th cell, there is a positive integer ai
 and a letter si
, where all si
 are either 'L' or 'R'.
...
In one operation, you can choose two indices l
 and r
 (1≤l<r≤n
) such that sl
 = 'L' and sr
