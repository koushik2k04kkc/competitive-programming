...
Note that all numbers in a
 are not necessarily different. In other words, some numbers of a
 may be same.

You have to answer independent t
 test cases.
...
Output
For each test case, print the rearranged version of array a
...
1 2 4 8
Note
In the first test case, after given rearrangement, |a1−a2|=0≤|a2−a3|=1≤|a3−a4|=2≤|a4−a5|=2≤|a5−a6|=10
. There are other possible answers like "5 4 5 6 -2 8".

In the second test case, after given rearrangement, |a1−a2|=1≤|a2−a3|=2≤|a3−a4|=4
