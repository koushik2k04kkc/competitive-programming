...
There are n
 students in the class, and you are given an array s
 in non-decreasing order, where si
 is the shoe size of the i
...
You have to output a permutation p
 of {1,2,…,n}
 denoting a valid shuffling of shoes, where the i
-th student gets the shoes of the pi
-th student (pi≠i
). And output −1
...
If a valid shuffling exists, print n
 space-separated integers — a permutation p
 of 1,2,…,n
 denoting a valid shuffling of shoes where the i
-th student gets the shoes of the pi
...
-1
Note
In the first test case, any permutation p
 of 1,…,n
 where pi≠i
 would represent a valid shuffling since all students have equal shoe sizes, and thus anyone can wear anyone's shoes.
