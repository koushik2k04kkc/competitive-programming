...
You are given some Tetris field consisting of n
 columns. The initial height of the i
-th column of the field is ai
 blocks. On top of these columns you can place only figures of size 2×1
 (i.e. the height of this figure is 2
 blocks and the width of this figure is 1
 block). Note that you cannot rotate these figures.
...
The following process occurs while at least one ai
 is greater than 0
:

You place one figure 2×1
 (choose some i
 from 1
 to n
 and replace ai
...
then, while all ai
 are greater than zero, replace each ai
 with ai−1
.
...
The next 2t
 ...
 is the initial height of the i
...
. Then place the figure in the first column and after the second step of the process, the field becomes [0,0]
.

In the fourth test case of the example, place the figure in the first column, then the field becomes [102]
 after the first step of the process, and then the field becomes [0]
